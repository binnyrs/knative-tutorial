...
This section details on setting up Knative on https://docs.okd.io/latest/minishift/getting-started/installing.html[minishift] starting from minishift profile setup to deploying Knative components such as https://github.com/knative/docs/tree/master/serving[Serving],  https://github.com/knative/docs/tree/master/build[Build] and  https://github.com/knative/docs/tree/master/eventing[Eventing].
...
xref:4routing_traffic.adoc[Routing Traffic]
...
This last section goes deeper into another important building block of https://github.com/knative/docs/tree/master/build[Build] 
