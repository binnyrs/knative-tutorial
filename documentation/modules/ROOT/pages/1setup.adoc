...
NOTE: It will take a few minutes for all the Istio components to be up and running. Please wait for all the Istio pods to be running before deploying <<install-knative-serving,Knative Serving>>.  Use CTRL+C to exit watch mode. 
...
NOTE: It will take a few minutes for all the Istio components to be up and running. Use CTRL+C to exit watch mode. 
